...
function Match({ visibleModal, setVisibleModal, match }) {
              ...
              <Dialog.Panel className="overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all">
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="mt-3 text-center sm:mt-0">
                    <Dialog.Title
                      as="h3"
                      className="font-syne font-semibold leading-6 text-[#2d0f38]"
                    >
                    ...
                    <div className="mt-2">
                      ...
                      <h1 className="font-semibold text-[#800f74] font-syne text-lg mt-4 mb-2">
