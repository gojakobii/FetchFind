    ...
    <div className="group">
      <div className="relative rounded-lg shadow">
        ...
        <div className="px-6 py-3 text-center">
          <h1 className="font-syne font-medium text-2xl text-[#800f74]">
            {props.name}
          </h1>
        ...
        {props.isFavorite ? (
          <button
            className="rounded-full w-10 h-10 shadow-md absolute top-0 right-0 m-2 bg-white p-2 transition-colors text-[#800f74]"
          ...
          <button
            className="rounded-full w-10 h-10 shadow-md absolute top-0 right-0 m-2 bg-white bg-opacity-50 p-2 text-white transition-colors hover:text-[#800f74] hover:bg-white"
            onClick={handleFavoriteDog}
          >
            <svg
              className="absolute top-0 right-0 m-2"
