...
function FetchFind(props) {
    ...
    useEffect(() => {
        const findDogs = async () => { // incorporate params for filtering i.e. breed/age/zip
            ...
            const url = `https://frontend-take-home-service.fetch.com/dogs/search?size=${size}&from=${(page-1)*size}
        ...
        <div>
                ...
                >
                  <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                    <div className="flex items-center justify-between px-4">
                      <h2 className="text-lg font-syne font-extrabold text-[#2d0f38]">Filters</h2>
                      <button
                        type="button"
                    ...
                    <form className="mt-4 border-t border-gray-200">
                      <Disclosure as="div" key={'dog_breed'} className="border-t border-gray-200 px-4 py-6">
                        {({ open }) => (
                          <>
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500">
                                <span className="font-medium font-lexend text-[#2d0f38]">Dog Breeds</span>
                            ...
                            <Disclosure.Panel className="pt-6">
                              ...
                              <div className="overflow-y-scroll max-h-52 space-y-6">
                                {
                                  allBreeds.map((breed) => (
                                    <div key={breed} className="flex ml-1 mt-1 items-center">
                                      <input
                                        type="checkbox"
                                        value={breed}
                                      ...
                                      />
                                      <label
                                        className="ml-3 font-lexend text-sm text-gray-600"
                                      >
                                        {breed}
                                      </label>
                                    </div>
                      ...
                      <Disclosure as="div" key={'age'} className="border-t border-gray-200 px-4 py-6">
                      {({ open }) => (
                        <>
                          <h3 className="-mx-2 -my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500">
                              <span className="font-medium font-lexend text-[#2d0f38]">Age</span>
                              <span className="ml-6 flex items-center">
                                {open ? (
                                  <MinusIcon className="h-5 w-5" aria-hidden="true" />
                                ) : (
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-16">
              <h1 className="text-4xl font-syne font-extrabold tracking-tight text-[#2d0f38]">FETCH FINDS</h1>
              <div className="flex items-center">
                <Menu as="div" className="font-lexend relative inline-block text-left">
                  <div>
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <div className="py-1">
                        <Menu.Item key='asc_breed' value='asc' onClick={() => 
                          {
                            setSort('asc');
                            setPage(1);
                          }}>
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                sort === 'asc' ? 'font-medium text-gray-900' : 'text-gray-500',
                                active ? 'bg-gray-100' : '',
                        ...
                        <Menu.Item key='desc_breed' value='desc' onClick={() => 
                          {
                            setSort('desc');
                            setPage(1);
                          }}>
                          {({ active }) => (
                            <a
                              href="#"
                              className={classNames(
                                sort === 'desc' ? 'font-medium text-gray-900' : 'text-gray-500',
                                active ? 'bg-gray-100' : '',
                                'block px-4 py-2 text-sm'
                              )}
                            >
            ...
            <section aria-labelledby="dogs-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <form className="hidden font-lexend lg:block">  
                    <Disclosure as="div" key={'dog_breed'} className="border-b border-gray-200 py-6">
                      {({ open }) => (
                        <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                              <span className="font-medium text-[#2d0f38]">Dog Breeds</span>
                              <span className="ml-6 flex items-center">
                                {open ? (
                                  <MinusIcon className="h-5 w-5" aria-hidden="true" />
                                ) : (
                    ...
                    <Disclosure as="div" key={'age'} className="border-b border-gray-200 py-6">
                      {({ open }) => (
                        <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                              <span className="font-medium text-[#2d0f38]">Age</span>
                              <span className="ml-6 flex items-center">
                                {open ? (
                                  <MinusIcon className="h-5 w-5" aria-hidden="true" />
                                ) : (
                  ...
                  <div className="bg-white">
                      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
                        {dogs.length > 0 ? (
                          ...
                          <h1 className="text-center font-lexend font-bold">Ruh-roh! No dogs were found!</h1>
                        )}
                      </div>
                  </div>
                </div>
